...
export const createThemes = (): Record<ThemeId, Theme> => Object.fromEntries(builtin.map((p) => {
...
export function applyTheme(t: Theme, agent = "#8b7cff", root: HTMLElement): ITheme {
  const r = root.style;
