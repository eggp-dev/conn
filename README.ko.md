...
| Windows · x64 | [Windows 설치 파일](https://github.com/eggplantiny/conn/releases/download/v0.4.1/conn-v0.4.1-x86_64-pc-windows-msvc-setup.exe) |
| Ubuntu · x64 | [.deb 다운로드](https://github.com/eggplantiny/conn/releases/download/v0.4.1/conn-v0.4.1-x86_64-unknown-linux-gnu-desktop.deb) · [AppImage](https://github.com/eggplantiny/conn/releases/download/v0.4.1/conn-v0.4.1-x86_64-unknown-linux-gnu-desktop.AppImage) |

[전체 다운로드와 체크섬](https://github.com/eggplantiny/conn/releases/tag/v0.4.1) · [설치 도움말](docs/getting-started.ko.md) · [플랫폼 지원](docs/platform-support.ko.md)
