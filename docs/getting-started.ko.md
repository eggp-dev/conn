...
```sh
sudo apt install ./conn-v0.8.1-x86_64-unknown-linux-gnu-desktop.deb
```

AppImage를 선택했다면 다음과 같이 실행합니다.

```sh
chmod +x ./conn-v0.8.1-x86_64-unknown-linux-gnu-desktop.AppImage
./conn-v0.8.1-x86_64-unknown-linux-gnu-desktop.AppImage
```
