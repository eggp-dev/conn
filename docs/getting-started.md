...
Download the [v0.5.0 preview](https://github.com/eggplantiny/conn/releases/tag/v0.5.0) for your OS and CPU. See the release notes for the exact signing and runtime verification results.

| Platform | Download | Install |
|---|---|---|
| Ubuntu x64 | [`.deb`](https://github.com/eggplantiny/conn/releases/download/v0.5.0/conn-v0.5.0-x86_64-unknown-linux-gnu-desktop.deb) | Run the command below, then open Conn from your applications. |
| Ubuntu x64 | [AppImage](https://github.com/eggplantiny/conn/releases/download/v0.5.0/conn-v0.5.0-x86_64-unknown-linux-gnu-desktop.AppImage) | Make the file executable, then open it. |
| macOS Apple Silicon | [`.dmg`](https://github.com/eggplantiny/conn/releases/download/v0.5.0/conn-v0.5.0-aarch64-apple-darwin-desktop.dmg) | Open the DMG, drag Conn into Applications, then launch it there. |
| Windows x64 | [Installer `.exe`](https://github.com/eggplantiny/conn/releases/download/v0.5.0/conn-v0.5.0-x86_64-pc-windows-msvc-setup.exe) | Run the installer, then open Conn from the Start menu. |
...
Download the CLI archive for [Linux x64](https://github.com/eggplantiny/conn/releases/download/v0.5.0/conn-v0.5.0-x86_64-unknown-linux-gnu-cli.tar.gz), [Mac Apple Silicon](https://github.com/eggplantiny/conn/releases/download/v0.5.0/conn-v0.5.0-aarch64-apple-darwin-cli.tar.gz), or [Windows x64](https://github.com/eggplantiny/conn/releases/download/v0.5.0/conn-v0.5.0-x86_64-pc-windows-msvc-cli.zip). Extract `conn` (`conn.exe` on Windows) to a directory on your user `PATH` and reopen your terminal.
