...
Conn provides its MIT-licensed source and native binaries through [GitHub Releases](https://github.com/eggp-dev/conn/releases/tag/v0.8.1). All desktop packages use the same Rust engine and Svelte UI. The browser harness is a development adapter.
