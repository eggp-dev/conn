...
Conn coordinates trusted humans and agent harnesses. It is **not a sandbox** and cannot contain a hostile agent or same-user process. Read the [trust model and data handling](docs/security.md) before using it with sensitive projects.
